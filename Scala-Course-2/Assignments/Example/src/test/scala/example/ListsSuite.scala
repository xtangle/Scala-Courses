 ...
 */
 @RunWith(classOf[JUnitRunner])
  ...
  test("sum of a singleton") {
    assert(sum(List(42)) === 42)
  }

  test("sum of a list containing negative numbers") {
    assert(sum(List(-3, 1, -8)) === -10)
  }
  ...
  test("sum of a list with repeated numbers") {
    assert(sum(List(0, 3, 3, -2, -2, 0)) === 2)
  }
  ...
  test("max of a singleton") {
    assert(max(List(30)) === 30)
  }

  test("max of a list containing negative numbers") {
    assert(max(List(-8, -3, -12)) === -3)
  }

  test("max of a list of zeros") {
    assert(max(List(0, 0, 0)) === 0)
  }

  test("max of a list with repeated numbers") {
    assert(max(List(2, 3, -1, -1, 3, 2)) === 3)
  }
}
